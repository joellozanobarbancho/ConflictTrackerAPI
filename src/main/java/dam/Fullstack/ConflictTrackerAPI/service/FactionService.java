...
public class FactionService {
    ...
    public FactionDTO getFactionById(Long id) {
        Faction faction = factionRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Faction not found with id: " + id));
    ...
    public FactionDTO createFaction(FactionCreateDTO createDTO) {
        ...
        if (createDTO.supporterCountryCodes() != null) {
    ...
    public void deleteFaction(Long id) {
        if (!factionRepository.existsById(id)) {
            throw new NotFoundException("Faction not found with id: " + id);
        }
    ...
    private FactionDTO toDTO(Faction faction) {
        ...
        Set<String> countryCodes =
                faction.getSupportingCountries() == null
                        ? Set.of()
                        : faction.getSupportingCountries().stream()
                        .map(Country::getCode)
